...
import box.reservations.repositories.TicketRepository;
...
public class AdminControlsService {
    ...
    public Ticket createTicket(@NotNull NewTicketCreationRequest request) throws NoSuchAlgorithmException {
